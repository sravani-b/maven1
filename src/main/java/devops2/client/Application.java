...
package devops2.client;

import devops2.client.gui.SearchPanel;
import devops2.client.i18n.ApplicationMessages;
...
public class Application implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		map.getMapModel().runWhenInitialized(new Runnable() {
			...
			public void run() {
				Label title = new Label(messages.applicationTitle("1.13.38"));
